...
/**
 * Base class to bakers that have a list (e.g. playlists, users).
 */
public abstract class ListBaker<R extends InfoItem> extends Baker {

    public ListBaker(StreamingService service, ListLinkHandler uiHandler) {
     ...
     *
     * @param pageUrl any page url got from the exclusive implementation of the list baker
