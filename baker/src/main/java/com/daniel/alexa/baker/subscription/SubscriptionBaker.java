package com.daniel.alexa.baker.subscription;
...
public abstract class SubscriptionBaker {

    /**
     * Exception that should be thrown when the input <b>do not</b> contain valid content that the
     * baker can parse (e.g. nonexistent user in case of a url extraction).
     */
    ...
    public SubscriptionBaker(StreamingService service, List<ContentSource> supportedSources) {
