...
public abstract class Baker {
    /**
     * {@link StreamingService} currently related to this baker.<br>
    ...
    public Baker(final StreamingService service, final LinkHandler uIHandler) {
        if(service == null) throw new NullPointerException("service is null");
        if(uIHandler == null) throw new NullPointerException("LinkHandler is null");
        this.service = service;
        this.uIHandler = uIHandler;
        this.downloader = Alexa.getDownloader();
        if(downloader == null) throw new NullPointerException("downloader is null");
    }

    /**
     * @return The {@link LinkHandler} of the current baker object (e.g. a ChannelBaker should return a channel url handler).
     */
    @Nonnull
