...
import static com.daniel.alexa.baker.buwa.BuwaPatternsManager.RESOURCE_BUNDLE_ARRAY_SEPARATOR;

public class GenerateResourceBundles {

    public static void main(String[] args) throws Exception {
        File outDir = new File("chewing-gum/outBundle");
        if (!outDir.isDirectory()) outDir.mkdir();

        JsonObject object = JsonParser.object().from(new FileInputStream(new File("chewing-gum/raw/unique_patterns.json")));
